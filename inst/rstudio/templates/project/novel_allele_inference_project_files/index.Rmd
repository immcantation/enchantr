...
eval_ <- !inherits(novel, "try-error") && nrow(novel) > 0
```
...
```{r plot-novel-alleles, eval=eval_, results='asis', echo=FALSE}
...
```{r save-inference, eval=eval_, results='asis'}
# Save novel report
