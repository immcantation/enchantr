...
uniqueCell  <- singlecell_sharing_matrix(db, group="sample_id", cell="cell_id", seq="sequence_alignment")

# plot duplicated cells
p <- enchantr:::plotOverlapSingleCell( list_objOverlap=list(uniqueCell, uniqueCell), titleText="", 
...
data = enchantr:::removeSingleCellDuplicates(db, group="sample_id", cell="cell_id", seq="sequence_alignment")
dim(data)
# data=rbind(data.ns, data)
# dim(data)
# write.table(data,file=paste0(subject,"_remDup.tsv"), quote=FALSE, sep="\t", row.names = FALSE)
#                            
# # Check overlap after removing duplicates
# uniqueCell  <- singlecell_sharing_matrix(data, group="SAMPLE", cell="CELL", seq="SEQUENCE_IMGT")
