...
```{r plot-genotype-inference, results='asis', fig.cap=caption, fig.height=12, fig.width=8}
genotype_plot <- plot_genotype(genotypes, allele_column = "genotyped_alleles", silent=TRUE)

caption <- "Genotype inference summary. Each row represents a specific gene, where the colored bars indicate the inferred alleles."

genotype_plot <- eeplot(genotype_plot,
  caption = caption,
  outdir = params$outdir,
  file = "plot-genotype-inference"
)
