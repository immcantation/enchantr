...
TIgGER Bayesian genotype inference for IG/TR repertoires.
</div>
...
In this section, genotype inference is performed using TIgGER's Bayesian approach. This method infers the most likely genotype for each individual by comparing observed mutation patterns to expected patterns for different genotype configurations.

The analysis uses prior probabilities for each gene family to weight the likelihood of different genotype configurations.
