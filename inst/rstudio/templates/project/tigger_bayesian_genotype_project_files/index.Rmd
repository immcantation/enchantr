...
<div class="introduction_paragraph">
The genotype table summarizes the inferred alleles for each gene, including the Bayes factor for each gene. 
</div>
...
<div class="introduction_paragraph">
The genotype plot provides a visual representation of the inferred alleles for each gene. 
</div>
