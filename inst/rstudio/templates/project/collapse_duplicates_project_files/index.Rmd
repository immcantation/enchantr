...
params:
   input: 
      ...
      input: file
      #value: "input.tsv"
      #value: "D:/Yale_Keinstein_lab/Airrflow_report_Improvement/Collapse_duplicate_report_update/rep1_meta-pass_collapse_collapse-pass.tsv"
      value: "D:/Yale_Keinstein_lab/Airrflow_report_Improvement/Collapse_duplicate_report_update/Upenn_5_samples_meta-pass_two_subjects_collapse_collapse-pass.tsv"
   collapseby:
      label: "`collapseby`"
      input: text
      #value: "sample_id"   
...
if (params$collapse_count_colname %in% colnames(db)){
  warning(paste0("Column ", params$collapse_count_colname, " already exists in the input data. Change the parameter 'collapse_cout_coname' to name the new column for collpased counts. Otherwise,the old one will be overwritten by the new one."))
