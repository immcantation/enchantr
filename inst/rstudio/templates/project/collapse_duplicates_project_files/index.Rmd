...
params:
   ...
   locus:
      ...
      input: text
      value: "IG"
   truncate_position_5_end:
      label: "truncate_position_5_end"
      input: numeric
      value: 80
   log:
      label: "`log`"
...
# Truncate 5-prime end at specific location
```{r truncate_all_from_5_end}
db <- truncate_all_from_5_end(db, params[["truncate_position_5_end"]])
```
