...
ggplotly(clone_size_plot + theme(panel.border = element_rect(color = "black", fill = NA, linewidth = 0.6), panel.spacing=unit(2, 'lines'), legend.position="right"),tooltip = "text")  %>%
...
ggplotly(clone_size_cdf_plot + 
           theme(panel.border = element_rect(color = "black", fill = NA, linewidth = 0.6), panel.spacing=unit(2, 'lines'), legend.position="right"),
         tooltip = "text") %>%
  layout(font = list(family = "Helvetica"))
