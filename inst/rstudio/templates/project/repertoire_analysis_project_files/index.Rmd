...
cat("# Bootstrapping Clonal Overlap Among Samples\n")

cat(paste0("\n Average clonal overlap among samples over all bootstrapping repetitions. Each cell is colored by the percentage of the average clonal overlap over the bootstrapping repetitions in the y-axis sample. Bootstrapping drew ",unique(a@n), " sequences from each sample each time for ", a@nboot, " bootstrapping repetitions. \n"))
