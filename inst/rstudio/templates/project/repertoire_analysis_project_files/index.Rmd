...
cat("# Clonal Overlap Among Samples\n")

if (text_size>0){
  cat("\n Heatmap of clonal overlap among samples. Numbers in each cell are the counts of clones shared by the x-axis sample and the y-axis sample. Percentages indicate the fraction of shared clones in the y-axis sample. Each cell is colored by percentage of clonal overlap. \n")
} else{
    cat("\n Heatmap of clonal overlap among samples. Each cell is colored by percentage of clonal overlap, which is the fraction of shared clones in the y-axis sample. \n")
}
...
cat(paste0("\n Heatmap of average bootstrapping clonal overlap among samples. Each cell is colored by the percentage of average bootstrapping clonal overlap in the y-axis sample. Bootstrapping drew ",unique(a@n), " sequences from each sample each time for ", a@nboot, " bootstrapping repetitions. \n"))
