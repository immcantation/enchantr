...
```{r abundanceTissue, eval=TRUE, fig.width=getPrettyWidth(length(unique(db[['tissue']])), ncols=3), fig.height=getPrettyHeight(length(unique(db[['tissue']])), ncols=3), fig.cap=caption}
