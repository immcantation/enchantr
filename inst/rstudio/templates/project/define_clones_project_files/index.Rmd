...
To compare samples, considering clone size as the number of sequences with the same
clone id is not the best option. Clonal abundance is the size of each clone 
