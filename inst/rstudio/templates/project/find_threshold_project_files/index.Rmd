...
params:
   input: 
      ...
      input: file
      value: "https://yale.box.com/shared/static/4k1k6ycgcje0z9a54ohb84w7ejjhva04.tsv"
   cloneby:
      label: "`cloneby`"
      input: text
      value: "sample_id"   
...
```{r showdtnplot, eval=!is.null(dtnplot), fig.width=8, fig.height=min(50, max(4, nrow(unique(db[,c("sample_id", params$singlecell)], drop=F))/1.5)), fig.cap=caption}
dtnplot <- dtnplot +
