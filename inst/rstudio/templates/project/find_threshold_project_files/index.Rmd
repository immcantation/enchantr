...
```{r dtnplot, fig.width=9, fig.height=2*nrow(unique(db[,c("sample_id", params$singlecell)], drop=F))/3, fig.cap=caption}
...
caption <- paste0("Distribution of the distance to the nearest sequence within ",
            ...
            "cross ",paste(params$cloneby, collapse=","),
            " distances are availalbe, they are shown in an inverse y-axis.")
